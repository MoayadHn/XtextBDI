		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAgentAccess().getEventsAssignment_4(), "rule__Agent__EventsAssignment_4");
					put(grammarAccess.getAgentAccess().getParametersAssignment_5(), "rule__Agent__ParametersAssignment_5");
					put(grammarAccess.getAgentAccess().getBeliefsAssignment_6(), "rule__Agent__BeliefsAssignment_6");
					put(grammarAccess.getAgentAccess().getPlansAssignment_7(), "rule__Agent__PlansAssignment_7");
					...
					put(grammarAccess.getBeliefSetAccess().getBeliefSetAssignment_3(), "rule__BeliefSet__BeliefSetAssignment_3");
					put(grammarAccess.getBeliefAccess().getNameAssignment_1(), "rule__Belief__NameAssignment_1");
					put(grammarAccess.getBeliefAccess().getFactAssignment_3(), "rule__Belief__FactAssignment_3");
