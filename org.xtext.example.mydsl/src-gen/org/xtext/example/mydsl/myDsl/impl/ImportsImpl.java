 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ImportsImpl#getImports <em>Imports</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImportsImpl extends MinimalEObjectImpl.Container implements Imports
{
  ...
  {
    return MyDslPackage.Literals.IMPORTS;
  }
  ...
  public EList<String> getImports()
  {
    if (imports == null)
    {
      imports = new EDataTypeEList<String>(String.class, this, MyDslPackage.IMPORTS__IMPORTS);
    }
    return imports;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.IMPORTS__IMPORTS:
        return getImports();
    }
