 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.OperatorImpl#isEqualTo <em>Equal To</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.OperatorImpl#isLargerThan <em>Larger Than</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.OperatorImpl#isSmallerThan <em>Smaller Than</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.OperatorImpl#isLargerOrEqualTo <em>Larger Or Equal To</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.OperatorImpl#isSmallerOrEqualTo <em>Smaller Or Equal To</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.OperatorImpl#isNotEqualTo <em>Not Equal To</em>}</li>
 * </ul>
 *
 * @generated
 */
